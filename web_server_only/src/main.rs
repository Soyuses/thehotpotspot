...
fn main() {
    ...
    println!("📋 Доступные страницы:");
    println!("   - http://localhost:8080 (главная)");
    println!("   - http://localhost:8080/owner_dashboard.html");
    println!("   - http://localhost:8080/customer_wallet.html");
    println!("   - http://localhost:8080/franchise_dashboard.html");
